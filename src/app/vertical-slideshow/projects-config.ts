...
export const PROJECTS: ProjectItem[] = [
  { imageUrl: 'assets/images/covers/00_01_Joao_Branco.jpeg', name: 'João Branco', identifier: Projects.JOAO_BRANCO, description: 'João Branco, São Martinho do Porto, 2023' },
  { imageUrl: 'assets/images/covers/00_02_25_Abril.jpeg', name: 'Margueira', identifier: Projects.ABRIL_25, description: 'Margueira, Cacilhas, 2021' },
